...
//       <div className="flex bg-white rounded-lg shadow-2xl overflow-hidden w-full max-w-4xl">
//         {/* Left Form Section */}
...
//             <button
//               type="submit"
//               className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg font-bold hover:from-blue-600 hover:to-blue-700 transition-shadow shadow-md hover:shadow-lg"
//             >
//               Add Product
//             </button>
//           </form>
...
//         {/* Right Image Section */}
//         <div className="w-1/2 bg-gradient-to-br from-blue-500 to-blue-700 text-white flex items-center justify-center">
